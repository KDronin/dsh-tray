// Browser-like editing helpers injected into the DSH window application.
// Replicates common browser/editor typing logic:
...
//
// All listeners use the CAPTURE phase so the page's own keydown handlers
// (which may call stopPropagation) can never swallow them.
'use strict'

window.__dshEditReady = true
...
function rangeInfo(t) {
  if (t.selectionStart !== undefined) {
    return { start: t.selectionStart, end: t.selectionEnd, collapsed: t.selectionStart === t.selectionEnd }
  }
...
document.addEventListener('keydown', (e) => {
  ...
  // typing the closing char right before an existing one just skips over it
